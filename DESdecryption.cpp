...
int main()
{
	...
	char hexMessage[]="0000000000000000", hexKey[]="0E329232EA6D0D73";
...
{
	int shifts[]={1,1,2,2,2,2,2,2,1,2,2,2,2,2,2,1}, index=16;
	...
	for (i=0; i<16; i++){
		for (j=0; j<48; j++){
			if ((PC_2[j]-1)<28){
				keys[index][j]=C[i+1][PC_2[j]-1];
			}else{
				keys[index][j]=D[i+1][PC_2[j]-28-1];
			}
